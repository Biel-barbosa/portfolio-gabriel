...
const Index = () => {
  ...
  const projetosManuais = [
  {
    ...
    description: "Loja online com filtros, carrinho e página de checkout, feita com Next.js, TypeScript e styled-components.",
    imageUrl: "/images/capputeeno.png",
    link: "https://capputeeno.vercel.app",
  },
  {
    id: 2,
    title: "To-do List Vue",
    description: "App simples de lista de tarefas feito com Vue.js e JavaScript puro, focado em reatividade.",
    imageUrl: "/images/todo-vue.png",
    link: "https://seulink.vercel.app",
  },
  {
    id: 3,
    title: "Sistema de Tarefas Vue + Pinia",
    description: "Organizador de tarefas com drag-and-drop, filtros por status e prioridade, e persistência local.",
    imageUrl: "/images/taskboard.png",
