...
import { ArrowLeft, Calendar, Github, Globe, Code, FileText, ExternalLink, Image, Folder, Star, GitFork, History } from 'lucide-react';
          ...
          {!isLoading && project && (
            <div className="animate-fade-in">
                  ...
                  {project.repoDetails && (
                    <div className="flex items-center gap-3 text-gray-400">
                      <div className="flex items-center">
                        ...
                        <span>{project.repoDetails.stars}</span>
                      </div>
                      
                      <div className="flex items-center">
                        <GitFork className="mr-1 h-4 w-4" />
                        <span>{project.repoDetails.forks}</span>
                      </div>
                    </div>
                  )}
                </div>
              ...
              <div className="grid md:grid-cols-3 gap-10">
                  ...
                  <div className="bg-white border border-white-800 rounded-lg p-8 mb-8">
                    ...
                    {project.primaryLanguage && (
                      <div className="flex items-center text-gray-500 mb-4">
                        ...
                        <span>Linguagem principal: <strong>{project.primaryLanguage}</strong></span>
                      </div>
                    )}
                    
                    {project.repoDetails && (
                      <div className="prose max-w-none text-gray-600">
                        <p>Criado em {formatDate(project.repoDetails.createdAt)} e última atualização em {formatDate(project.repoDetails.updatedAt)}.</p>
                      </div>
                    )}
                  </div>
                ...
                <div>
                  <div className="bg-white-900 border border-white-800 rounded-lg p-6">
                    ...
                    <div className="flex flex-col space-y-4">
                      ...
                      {project.repoDetails?.homepage && project.repoDetails.homepage !== project.deployUrl && (
                        <Button variant="secondary" className="w-full justify-start" asChild>
                          <a 
                            href={project.repoDetails.homepage}
                            target="_blank" 
                            rel="noopener noreferrer"
                          >
