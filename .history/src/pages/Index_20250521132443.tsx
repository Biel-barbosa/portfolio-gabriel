...
const Index = () => {
  ...
  const projetosManuais = [
   {
    ...
    description: "Loja online com filtros, carrinho e checkout. Feita com Next.js e TypeScript.",
  ...
  },
  {
    id: 2,
    name: "To-do List Vue",
    description: "Lista de tarefas simples feita com Vue.js e JavaScript puro.",
  ...
  {
    id: 3,
    name: "Task Board Vue + Pinia",
    description: "Sistema de tarefas com filtros, drag and drop e localStorage.",
