    ...
    <div className="min-h-screen flex flex-col bg-white text-black">
      ...
      <main className="flex-grow pt-24 pb-16 px-4">
        <div className="container mx-auto">
          <Link 
            to="/projetos" 
            className="inline-flex items-center text-sm text-gray-300 hover:text-primary transition-colors mb-8"
          >
          ...
          {!isLoading && project && (
            <div className="animate-fade-in">
              ...
              <div className="rounded-lg overflow-hidden mb-10 h-[400px] bg-slate-800 border border-slate-700">
                {project.imageUrl ? (
                  <img 
                  ...
                  <div className="bg-slate-900 border border-slate-800 rounded-lg p-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                      {project.technologies && project.technologies.map((tech, index) => (
                        <div key={index} className="bg-slate-800 border border-slate-700 rounded-lg p-4 flex items-center gap-3">
