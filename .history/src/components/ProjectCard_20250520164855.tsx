...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, featured = false }) => {
  ...
  return (
    <Card className={`overflow-hidden flex flex-col bg-white border-white text-black hover:border-primary transition-all duration-300 border-l-4 border-l-[##4f4f4f]`}>
