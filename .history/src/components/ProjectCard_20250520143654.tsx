...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, featured = false }) => {
  ...
  return (
    <Card className={`overflow-hidden flex flex-col bg-slate-900 border-slate-800 text-white hover:border-primary transition-all duration-300 ${featured ? 'border-l-4 border-l-primary' : ''}`}>
